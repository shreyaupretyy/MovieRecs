...
def fetch_and_store_movies(db, Movie, force_refresh=False):
    ...
    POPULAR_MOVIE_IMDB_IDS = [
        ...
        'tt0307901',  # Oldboy (removed duplicate)
        'tt0443706',  # Zodiac
        'tt0401792',  # Sin City
        ...
        'tt0088247',  # The Terminator (removed duplicate)
        'tt0088258',  # Brazil
        ...
        'tt0047396',  # Rear Window (removed duplicate)
        ...
        'tt0041546',  # The Third Man (removed duplicate)
    ...
    # Generate additional IMDb IDs programmatically to reach ~300
    # IMDb IDs typically start with 'tt' followed by 7 digits
    # For newer movies, they use 'tt' followed by 7-8 digits

    # Add a good mix of movies from 1920s-2020s
    ...
    try:
        ...
        for imdb_id in POPULAR_MOVIE_IMDB_IDS:
            try:
                ...
                logger.info(f"Fetching data for movie {imdb_id} from OMDb API")
        ...
        logger.info(f"Replaced {replaced_sample_movies} sample movies with API data")
        ...
        if successful_fetches > 0:
            ...
            return {
                "status": "warning",
                "message": "No new movies were added from OMDb API"
            }
